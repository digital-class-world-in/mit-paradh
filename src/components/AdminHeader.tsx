...
import { LogOut, ChevronDown, Settings, Trash2, Globe, FileText } from 'lucide-react';
...
interface MenuItem {
  ...
  id: number;
  icon?: any;
  subItems?: { label: string; id: number }[];
  isExternal?: boolean;
}
...
export default function AdminHeader({ activeTab, setActiveTab, onLogout, adminName }: AdminHeaderProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { 
      label: 'Student info', 
      id: 2,
      subItems: [{ label: 'Admission confirm', id: 3022 }, { label: 'Pending admission', id: 3024 }, { label: 'Cancel admission', id: 3023 }, { label: 'Approved admission', id: 25 }, { label: 'Student registration', id: 19 }]
    },
    { 
      label: 'Examination', 
      id: 600,
    ...
    { 
      ...
      subItems: [
        ...
        { label: 'Inquiry', id: 103 },
        { label: 'Contact Us', id: 104 }
      ]
    },
