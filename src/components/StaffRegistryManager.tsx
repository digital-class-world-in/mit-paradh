...
import { Users, Search, Plus, User, ShieldCheck, Edit2, Trash2, X, ChevronRight, Loader2, Link as LinkIcon } from 'lucide-react';
...
const StaffRegistryManager = ({ collegeId }: StaffRegistryManagerProps) => {
  ...
  useEffect(() => {
    ...
    onValue(collegesRef, (collegeSnap) => {
           ...
           <div className="relative w-full max-w-5xl bg-[#f8fafc] rounded-[3rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-300">
              ...
              <div className="flex-1 overflow-y-auto p-10 space-y-8 no-scrollbar">
                  ...
                  <div className="pt-6 border-t border-slate-200 grid grid-cols-1 md:grid-cols-2 gap-6">
                     ...
                     <InputField label="Initial Password" type="password" value={addForm.password} onChange={(v: string) => setAddForm({ ...addForm, password: v })} placeholder="••••••••" />
                  </div>
              </div>
