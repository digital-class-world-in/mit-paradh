        ...
        <main className="p-10 pt-32 flex-1">
          ...
          {activeTab === 201 ? (
            ...
            <div className="space-y-8 animate-in slide-in-from-bottom-8 duration-500">
              ...
              {/* Filter Bar */}
              <div className="bg-white rounded-[2.5rem] p-10 border border-black shadow-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 items-end">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    className="w-full bg-slate-50 border border-black rounded-xl py-3.5 px-4 text-xs font-normal outline-none focus:bg-white focus:border-[#00a5a5] transition-all cursor-pointer"
                    value={filterType}
                ...
                <div className="space-y-2">
                  <label className="text-[13px] font-normal text-black capitalize tracking-tight pl-1">Affiliate ID</label>
                  <select
                    className="w-full bg-slate-50 border border-black rounded-xl py-3.5 px-4 text-xs font-normal outline-none focus:bg-white focus:border-[#00a5a5] transition-all cursor-pointer"
